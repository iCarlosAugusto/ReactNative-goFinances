  ...
  async function loadTransactions(){
    ...
    setHighlightData({
      entries: {
        ...
        lastTransaction: lastTransactionEntries === 'NaN de Invalid Date' ? 'Sem registro de entradas'
      ...
      expensives: {
        ...
        lastTransaction: lastTransactionExpensives === 'NaN de Invalid Date' ? 'Sem registro de saídas'
